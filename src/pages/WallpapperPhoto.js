        ...
        <div className="flex flex-auto">
            ...
            <div className="flex-auto relative h-screen">
                ...
                <div className="absolute bottom-0 left-0 bg-white w-[414px] border-l-[1px] border-[#F5F5F5] px-[53px]">
                    <p className="leading-4 pt-[45px] mb-[7px] text-[12px] font-['Manrope'] tracking-[3.42px] text-[#D8D8D8]">AUTHOR BY</p>
                    <h2 className="mb-[2px] text-[52px] font-['Abhaya_Libre'] leading-[61px]">{image?.user?.name}</h2>
                    <h3 className="pb-[39px] text-[18px] font-['Abhaya_Libre'] leading-8">
            ...
            <div className='flex-none max-w-[750px] h-screen bg-white flex flex-col justify-between'>
                <div>
                    ...
                    <div className="ml-[91px] mr-[87px] mb-[32px] w-[512px] h-[209px] text-[18px] leading-8 text-ellipsis">
